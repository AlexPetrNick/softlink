            ...
            <div className="computer__data">
                <div className="computer__slot__wrapper">
                    <div className="computer__slot">
                        <ComputerNameItem cntError={cntError} setCntError={setCntError} text='Материнка'
                                          cntReal={props.realStatComp.realCntMother}
                                          cntFix={genStatComp.generalCntMother}/>
                        <ComputerNameItem cntError={cntError} setCntError={setCntError} text='Процессор'
                                          cntReal={realStatComp.realCntCpu} cntFix={genStatComp.generalCntCpu}/>
                        <ComputerNameItem cntError={cntError} setCntError={setCntError} text='Видеокарта'
                                          cntReal={realStatComp.realCntVideo} cntFix={genStatComp.generalCntVideo}/>
                        <div className="computer__data__name">
                            <ComputerNameItem cntError={cntError} setCntError={IterCntErr} text='Оперативная'
                        ...
                        <div className="computer__data__name">
                            ...
                            <ComputerNameItem cntError={cntError} setCntError={IterCntErr} text='Блок питания'
